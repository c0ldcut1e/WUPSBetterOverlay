...
bool loadTexShader(WHBGfxShaderGroup &grp) {
    return WHBGfxLoadGFDShaderGroupMappedMem(&grp, 0, TexShaderData);
}

void unloadTexShader(WHBGfxShaderGroup &grp) {
    WHBGfxFreeShaderGroupMappedMem(&grp);
}

void initTexShaderAttrs(WHBGfxShaderGroup &grp) {

...
bool loadImGuiShader(WHBGfxShaderGroup &grp) {
    return WHBGfxLoadGFDShaderGroupMappedMem(&grp, 0, ImGuiShaderData);
}

void unloadImGuiShader(WHBGfxShaderGroup &grp) {
    WHBGfxFreeShaderGroupMappedMem(&grp);
}

void initImGuiShaderAttrs(WHBGfxShaderGroup &grp) {
    WHBGfxInitShaderAttribute(&grp, "Position", 0, 0,
                              GX2_ATTRIB_FORMAT_FLOAT_32_32);
    WHBGfxInitShaderAttribute(&grp, "UV", 0, 8, GX2_ATTRIB_FORMAT_FLOAT_32_32);
    WHBGfxInitShaderAttribute(&grp, "Color", 0, 16, GX2_ATTRIB_TYPE_8_8_8_8);
